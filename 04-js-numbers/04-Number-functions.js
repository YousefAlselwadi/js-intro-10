...
console.log(10.951.toFixed(2)); // 10.96
...
console.log(Number.isInteger(872327827237883723)); // true
console.log(Number.isSafeInteger(87232782723788372398458948545)); // false

...
const countChars = (str) => {
  const counts = { letters: 0, numbers: 0, specials: 0 };
  ...
  if (counts.letters === 0) delete counts.letters;
  if (counts.numbers === 0) delete counts.numbers;
  if (counts.specials === 0) delete counts.specials;
  return counts;
};
